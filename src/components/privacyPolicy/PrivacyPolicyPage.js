    ...
    return(
        <div style={{padding: '20px'}}>
            <div style={{border: '2px solid green', padding: '20px'}}><center><strong>Privacy Notice</strong></center>
                <p>This privacy notice discloses the privacy practices for <span style={{textDecoration: 'underline'}}>{Labels.app_title}</span>. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
                <ol type="1">
                ...
                <p><strong>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at <a href={`tel:${Labels.privacy_policy.phone_number}`}>{Labels.privacy_policy.phone_number}</a> or <span style={{textDecoration: 'underline'}}>via email at <a href="mailto:{Labels.privacy_policy.email_address}">{Labels.privacy_policy.email_address}</a></span>.</strong></p>
            </div>
        </div>
    );
};
